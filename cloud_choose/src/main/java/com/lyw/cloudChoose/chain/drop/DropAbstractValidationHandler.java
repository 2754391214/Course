 ...
 */
@Slf4j
public abstract class DropAbstractValidationHandler implements DropValidationHandler {

    protected DropValidationHandler nextHandler;

    @Override
    public void setNextHandler(DropValidationHandler nextHandler) {
