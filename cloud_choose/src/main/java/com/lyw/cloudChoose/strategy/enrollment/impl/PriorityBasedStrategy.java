...
public class PriorityBasedStrategy implements EnrollmentStrategy {
    ...
    public CourseResponseWrapper enroll(EnrollmentsDto request, CoursesDto course, EnrollmentStrategiesVo strategy) {
        ...
        return handleEnrollResult(enrollResult, request, strategy, priority, course, studentId);
    }
     ...
     * 根据选课结果处理不同的情况
     */
    private CourseResponseWrapper handleEnrollResult(Long enrollResult, EnrollmentsDto request,EnrollmentStrategiesVo strategy,
                                                     int priority, CoursesDto course, Long studentId) {
