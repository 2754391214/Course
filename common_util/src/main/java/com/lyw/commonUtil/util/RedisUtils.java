...
public class RedisUtils {
    ...
    //redis数据过期时间,单位分钟
    public static final long DATA_TTL = 30;
    @Resource
     ...
     * @param value
     */
    public void setDefultEx(String key, Object value) {
        redisTemplate.opsForValue().set(key, value, DATA_TTL, TimeUnit.MINUTES);
    }
     ...
     * @return
     */
    public <T> List<T> hMultiGet(String key, Collection<Object> fields) {
        return (List<T>) redisTemplate.opsForHash().multiGet(key, fields);
    }
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<Object>> reverseRangeWithScores(String key, int min, int max) {
